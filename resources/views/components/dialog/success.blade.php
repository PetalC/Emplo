{{-- Simple alert from Tailwind UI --}}
{{--
Usage, specify your success message in the main slot of the component
E.g.
<x-dialog.success :title="Decline" action-text="Decline" :show="$showDeclineAlert">
...
<div class="relative z-10 hidden {{ !$show ?? 'hidden'  }}" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <!--
